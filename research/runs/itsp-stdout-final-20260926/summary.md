...
- IF NOT (test:7=pass) AND NOT (stdout:4:relation=different) THEN cụm 0; train n=2, validation n=1, precision=0.0.
- IF NOT (test:7=pass) AND stdout:4:relation=different THEN cụm 0; train n=6, validation n=0, precision=None.
- IF test:7=pass THEN cụm 2; train n=3, validation n=1, precision=0.0.
...
- IF NOT (test:2=fail) THEN cụm 2; train n=3, validation n=1, precision=0.0.
- IF test:2=fail AND NOT (stdout:6:relation=different) THEN cụm 0; train n=2, validation n=1, precision=0.0.
- IF test:2=fail AND stdout:6:relation=different THEN cụm 0; train n=6, validation n=0, precision=None.
...
- IF NOT (test:7=pass) AND NOT (stdout:4:relation=different) THEN cụm 1; train n=2, validation n=1, precision=0.0.
- IF NOT (test:7=pass) AND stdout:4:relation=different THEN cụm 1; train n=6, validation n=0, precision=None.
- IF test:7=pass THEN cụm 0; train n=3, validation n=1, precision=0.0.
...
- IF NOT (test:2=fail) THEN cụm 0; train n=3, validation n=1, precision=0.0.
- IF test:2=fail AND NOT (stdout:6:relation=different) THEN cụm 1; train n=2, validation n=1, precision=0.0.
- IF test:2=fail AND stdout:6:relation=different THEN cụm 1; train n=6, validation n=0, precision=None.
...
- IF NOT (test:7=pass) AND NOT (test:3=fail) THEN cụm 1; train n=2, validation n=0, precision=None.
- IF NOT (test:7=pass) AND test:3=fail THEN cụm 2; train n=9, validation n=2, precision=1.0.
...
- IF NOT (stdout:7:relation=exact) AND NOT (stdout:4:relation=different) THEN cụm 1; train n=2, validation n=1, precision=0.0.
- IF NOT (stdout:7:relation=exact) AND stdout:4:relation=different THEN cụm 2; train n=9, validation n=1, precision=1.0.
- IF stdout:7:relation=exact THEN cụm 0; train n=9, validation n=0, precision=None.
...
- IF NOT (test:2=pass) AND NOT (test:4=fail) THEN cụm 1; train n=4, validation n=0, precision=None.
- IF NOT (test:2=pass) AND test:4=fail THEN cụm 2; train n=9, validation n=2, precision=1.0.
- IF test:2=pass THEN cụm 0; train n=7, validation n=0, precision=None.
...
- IF NOT (stdout:6:edit_band=small) AND NOT (stdout:2:edit_band=large) THEN cụm 2; train n=3, validation n=0, precision=None.
- IF NOT (stdout:6:edit_band=small) AND stdout:2:edit_band=large THEN cụm 1; train n=2, validation n=0, precision=None.
...
- IF NOT (stdout:6:edit_band=small) AND NOT (stdout:2:edit_band=large) THEN cụm 0; train n=3, validation n=0, precision=None.
- IF NOT (stdout:6:edit_band=small) AND stdout:2:edit_band=large THEN cụm 2; train n=2, validation n=0, precision=None.
